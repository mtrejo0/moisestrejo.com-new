...
const forceRegenerateIds = ["bad_ending"];
...
async function generateImage(description, id) {
  ...
  try {
    ...
    const basePrompt =
      "Using DALL-E 3, create a dark, atmospheric 1950s-style American diner at night. The scene should be photorealistic with cinematic lighting, deep shadows, and a sense of foreboding. Include flickering neon signs casting an eerie glow, chrome fixtures, and vinyl booths. Scene description: ";
